...
{
    [CustomEditor(typeof (StandardAssets_Antialiasing))]
    public class StandardAssets_AntialiasingEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Material mat = (target as StandardAssets_Antialiasing).CurrentAAMaterial();
            if (null == mat && (target as StandardAssets_Antialiasing).enabled)
            {
